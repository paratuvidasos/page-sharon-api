...
export const UpdateProfileRequestSchema = z
  ...
  .superRefine((data, ctx) => {
    if (!isValidPhoneNumber(data.phone, data.phoneCountryCode as CountryCode)) {
      ctx.addIssue({
  ...
  .transform((data) => ({
    ...
    phone: parsePhoneNumber(data.phone, data.phoneCountryCode as CountryCode).number as string,
  }));
